...
const questions = [
    ...
    },
    {
        ...
        answers: [
            { text: "Yes", result: "<a href='https://example.com'>Shoreline setbacks</a><br><br>Click the hyperlink above to learn more <strong>OR</strong><br><br>Not a good solution for you?click 'Back' and choose 'No' to find a different tool." },
            { text: "No", followUp: 2 }
        ]
    },
    {
