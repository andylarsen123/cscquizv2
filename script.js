...
const questions = [
    ...
    },
    {
        ...
        answers: [
            { text: "Yes", result: "<a href='https://example.com'><strong>Shoreline setbacks</strong></a><br><br>Click the hyperlink above to learn more.<br><br><strong>Not a good solution for you?</strong> Click 'Back' and choose 'No' to find a different tool." },
            { text: "No", followUp: 2 }
        ]
    },
    {
