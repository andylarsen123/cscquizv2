...
const questions = [
    ...
    },
    {
        ...
        answers: [
            { text: "Yes", result: "Shoreline setbacks<br><br>Click the hyperlink above to learn more<br><strong>OR</strong><br>click Back and choose No to find a different tool." },
            { text: "No", followUp: 2 }
        ]
    },
    {
